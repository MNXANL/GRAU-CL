...
public:
  ...
  virtual void enterMinus(ExprParser::MinusContext * /*ctx*/) override { }
  virtual void exitMinus(ExprParser::MinusContext * /*ctx*/) override { }

  virtual void enterProd(ExprParser::ProdContext * /*ctx*/) override { }
  virtual void exitProd(ExprParser::ProdContext * /*ctx*/) override { }

  virtual void enterParenthesis(ExprParser::ParenthesisContext * /*ctx*/) override { }
  virtual void exitParenthesis(ExprParser::ParenthesisContext * /*ctx*/) override { }
